...
private:
    ...
    void knn_(Point<N> key, KDTreeNode* currentNode, KDTreeNode*& guest, double& bestDistance, int depth) const;
};

template <size_t N, typename ElemType>
void KDTree<N, ElemType>::knn_(Point<N> key, KDTreeNode* currentNode, KDTreeNode*& guest, double& bestDistance, int depth)
const
{
    ...
    knn_(key, currentNode->children[!child], guest, bestDistance, ++depth);
